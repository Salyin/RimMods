...
namespace OutlandTerrain
{
    public class OutlandTerrainSettings : ModSettings
    {
        ...
        public bool additionalStoneFloors = true;
        public bool additionalWoodFloors = true;
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref additionalStoneFloors, "additionalStoneFloors", true);
            Scribe_Values.Look(ref additionalWoodFloors, "additionalWoodFloors", true);
        }
